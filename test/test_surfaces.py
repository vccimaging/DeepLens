...
class TestAsphericSurface:
    ...
    def test_aspheric_reduces_to_spheric(self, device_auto):
        ...
        asph = Aspheric(
            c=c, k=0.0, ai=[0.0] * 6, r=r, d_next=0.0, mat2="bk7", device=device_auto
        )
    ...
    def test_aspheric_conic_parabola(self, device_auto):
        ...
        c = 0.1
        surf = Aspheric(
            c=c, k=-1.0, ai=[0.0] * 6, r=5.0, d_next=0.0, mat2="bk7", device=device_auto
        )
    ...
    def test_aspheric_higher_order(self, device_auto):
        ...
        surf = Aspheric(
            c=c, k=0.0, ai=ai, r=5.0, d_next=0.0, mat2="bk7", device=device_auto
        )
...
class TestSurfaceBase:
    ...
    def test_surface_reflect(self, device_auto):
        ...
        surf = Spheric(
            c=0.0, r=5.0, d_next=10.0, mat2="bk7", device=device_auto
        )  # Flat mirror
